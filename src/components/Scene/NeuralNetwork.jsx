...
export default function NeuralNetwork() {
  ...
  const particlesData = useMemo(() => new Array(maxParticleCount).fill({ velocity: new Vector3(), numConnections: 0 }), [maxParticleCount])
  ...
  useEffect(() => {
    for (let i = 0; i < maxParticleCount; i++) {
      ...
      particlesData[i] = { velocity: v.normalize().divideScalar(50), numConnections: 0 }
    }
  ...
  return (
    <group ref={groupRef} dispose={null}>
      <points>
        ...
        <pointsMaterial color={'#f6f3ee'} size={3} blending={AdditiveBlending} transparent={true} sizeAttenuation={false} />
      </points>
      <lineSegments>
        ...
        <lineBasicMaterial color="#025a4e" vertexColors={true} blending={AdditiveBlending} transparent={true} />
      </lineSegments>
    </group>
  )
}
